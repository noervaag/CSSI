...
namespace sstss
{
    ...
    struct SemRect
    {
	EmbeddingHD m_min;                      ///< Min dimensions of bounding box
	EmbeddingHD m_max;                      ///< Max dimensions of bounding box
    };
	...
	double minSemDist(SemRect const& semRect, EmbeddingHD const& q);
