...
namespace sstss
{
    ...
    std::ostream& operator << (std::ostream &o, const EmbeddingHD &ev) /* < Defining << for SemVec */
    {
	o << "[ ";
	for (auto const& e : ev)
	    { o << e << " "; }
    ...
    std::ostream& operator << (std::ostream &o, const EmbeddingLD &ev) /* < Defining << for SemVec */
    {
	o << "[ ";
	for (auto const& e : ev)
	    { o << e << " "; }
